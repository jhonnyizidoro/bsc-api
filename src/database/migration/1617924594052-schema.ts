...
export class schema1617924594052 implements MigrationInterface {
    name = 'schema1617924594052'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `signatureValues` (`id` varchar(36) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `value` float NOT NULL, `day` int NOT NULL, `month` int NOT NULL, `year` int NOT NULL, `signatureId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
